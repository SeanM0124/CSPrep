...
const Content = (props) => {
  return (
    <>
      ...
      <Part exercises={props.course.parts[1].exercises} name={props.course.parts[1].name}/>
      <Part exercises={props.course.parts[2].exercises} name={props.course.parts[2].name}/>
    </>
  );
}
